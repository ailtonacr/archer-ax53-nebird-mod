...
def check_build_pipeline() -> None:
    ...
    require(mod,
        ...
        'grep -Ev \'^[[:space:]]*#\' "$R/lib/netifd/proto/netbird.sh"',
        '| grep -q \'/sbin/netbird-ctl\'; then',
        'NB_FW_CANONICAL=',
        'NetBird v4 CIDR-scoped\\/applied-state',
        'printf \'%s\\n\' "$NB_FW_CANONICAL"',
        'canonical TP-Link NetBird FORWARD rule is inserted ahead of NetBird Route ACLs',
