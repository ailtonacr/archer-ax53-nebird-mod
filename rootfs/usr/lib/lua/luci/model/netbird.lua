...
function set_settings(cand)
    ...
    local lan = cur.advertise_lan or KEYS.advertise_lan.default
    local cidr = cur.advertise_cidr or KEYS.advertise_cidr.default
    if lan == "1" and cidr == "" then return nil, "advertise_cidr required when LAN routing is enabled" end
