...
NAT_FILTER_CHAINS="zone_lan_natfd_vpn zone_lan_natfd_vsgaming zone_lan_natfd_vs zone_lan_natfd_dmz forwarding_rule_pt "\
"zone_wan_natfd_vsgaming zone_wan_natfd_vs zone_wan_natfd_dmz"
