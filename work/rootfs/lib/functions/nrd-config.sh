...
nrd_create_config() {
	...
	__nrd_cfg_add_rssi_est_str	IdleSteer	RSSISteeringPoint_UG	Estimator_Adv	RSSIDiff_EstW6FromW2	InactRSSIXingHighThreshold $filename
	...
	__nrd_cfg_add_rssi_est_str	IdleSteer	RSSISteeringPoint_UG	Estimator_Adv	RSSIDiff_EstW6FromW5	InactRSSIXingHighThreshold $filename
	...
	__nrd_cfg_add_str	Estimator_Adv	BcnrptActiveDuration $filename
	__nrd_cfg_add_str	Estimator_Adv	BcnrptPassiveDuration $filename
	__nrd_cfg_add_str_new_key	ActiveSteer	TxRateXingThreshold_UG_FromW5	HighTxRateXingThreshold_FromW5 $filename
	__nrd_cfg_add_str_new_key	ActiveSteer	RateRSSIXingThreshold_UG_FromW5	HighRateRSSIXingThreshold_FromW5 $filename
	...
	__nrd_cfg_add_str   IdleSteer   AuthAllow $filename
	__nrd_cfg_add_str_new_key	IdleSteer	RSSISteeringPoint_UG	InactRSSIXingHighThreshold $filename
	__nrd_cfg_add_rssi_est_str	IdleSteer	RSSISteeringPoint_DG	Estimator_Adv	RSSIDiff_EstW5FromW6	InactRSSIXingLowThreshold $filename
	__nrd_cfg_add_str	SteerExec_Adv	LowRSSIXingThreshold $filename
	__nrd_cfg_add_str	Estimator_Adv	BcnrptActiveDuration $filename
	__nrd_cfg_add_str	Estimator_Adv	BcnrptPassiveDuration $filename
	__nrd_cfg_add_str_new_key	ActiveSteer	TxRateXingThreshold_DG_FromW6	LowTxRateXingThreshold_FromW6 $filename
	__nrd_cfg_add_str_new_key	ActiveSteer	RateRSSIXingThreshold_DG_FromW6	LowRateRSSIXingThreshold_FromW6 $filename
	__nrd_cfg_add_ap_steering_thresh	APSteer	LowRSSIAPSteerThreshold_CAP_W6	LowRSSIAPSteerThreshold_CAP	LowRSSIAPSteeringThreshold	$filename
	...
	__nrd_cfg_add_str	TriggerMonitor	RSSIMeasureSamples_W6 $filename
    ...
    if [ "$device_type" = 'AP' ]; then
		...
		__nrd_cfg_add_ap_steering_thresh    APSteer LowRSSIAPSteerThresholdIni_CAP_W6  LowRSSIAPSteerThreshold_CAP LowRSSIAPSteeringThreshold_W6   $filename
		...
		__nrd_cfg_add_ap_steering_thresh    APSteer LowRSSIAPSteerThresholdIni_RE_W6  LowRSSIAPSteerThreshold_RE LowRSSIAPSteeringThreshold_W6   $filename
	...
	__nrd_cfg_add_str   TriggerMonitor  LowAPSteerThresholdFloor_W6  $filename

	__nrd_cfg_nl_append '[ESTIMATOR]' $filename
	__nrd_cfg_add_str   config_Adv  AgeLimit $filename
	__nrd_cfg_add_str   Estimator_Adv   RSSIDiff_EstW5FromW2 $filename
	__nrd_cfg_add_str   Estimator_Adv   RSSIDiff_EstW6FromW2 $filename
	__nrd_cfg_add_str   Estimator_Adv   RSSIDiff_EstW6FromW5 $filename
	__nrd_cfg_add_str   Estimator_Adv   RSSIDiff_EstW2FromW5 $filename
	__nrd_cfg_add_str   Estimator_Adv   RSSIDiff_EstW5FromW6 $filename
	...
	__nrd_cfg_add_str_new_key	SteerExec_Adv	LowRSSIXingThreshold	LowRSSIXingThreshold_W6 $filename
	...
	__nrd_cfg_add_str	SteerExec_Adv	TargetLowRSSIThreshold_W6 $filename
	...
	__nrd_cfg_add_str_new_key	IdleSteer	RSSISteeringPoint_UG	InactRSSIXingThreshold_W6 $filename
	__nrd_cfg_add_str_new_key	ActiveSteer	TxRateXingThreshold_UG	HighTxRateXingThreshold $filename
	__nrd_cfg_add_str_new_key	ActiveSteer	RateRSSIXingThreshold_UG	HighRateRSSIXingThreshold $filename
	__nrd_cfg_add_str_new_key	ActiveSteer	TxRateXingThreshold_DG	LowTxRateXingThreshold $filename
	__nrd_cfg_add_str_new_key	ActiveSteer	RateRSSIXingThreshold_DG	LowRateRSSIXingThreshold $filename
	...
	__nrd_cfg_add_str   APSteer DownlinkRSSIThreshold_W6    $filename
