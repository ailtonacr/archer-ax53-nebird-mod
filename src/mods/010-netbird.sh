...
# The NetBird binary is NOT embedded in rootfs; it is materialized at runtime
# from the netbird_data partition (see 011-netbird-web.sh and docs).
...
# 4) factory reset cleanup (remove config, keep payload partition)
